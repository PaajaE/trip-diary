export const en = {
  ...
  reader: {
    ...
    closingDescription:
      'Share the trip with family, explore more from this diary, or sign in if you want your name on comments.',
    closingEyebrow: 'Stay connected',
    closingShareTrip: 'Share this trip',
    closingSignInOptional: 'Sign in (optional)',
    closingTitle: 'Want to see more?',
