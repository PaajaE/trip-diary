...
export const cs: TranslationResources = {
  ...
  reader: {
    ...
    closingDescription:
      'Sdílejte cestu s rodinou, prohlédněte si další zápisky z tohoto deníku, nebo se přihlaste, pokud chcete u komentářů zobrazit své jméno.',
    closingEyebrow: 'Zůstaňte v kontaktu',
    closingShareTrip: 'Sdílet tuto cestu',
    closingSignInOptional: 'Přihlásit se (volitelné)',
    closingTitle: 'Chcete vidět víc?',
