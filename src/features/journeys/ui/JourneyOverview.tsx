...
export function JourneyOverview({
  ...
  return (
    <section className="scroll-mt-24 py-6 sm:scroll-mt-20 sm:py-8">
      ...
      {isEmpty && !canEdit ? (
        <div className="mt-8 rounded-xl border border-dashed border-border bg-surface p-6 shadow-soft">
        ...
        <div className="mt-8 scroll-mt-24 sm:scroll-mt-20" id="story">
          <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
            <h2 className="text-lg font-semibold">{t('journey.moments')}</h2>
            {canEdit && onAddMoment !== undefined ? (
              <button
                className="inline-flex min-h-11 items-center gap-2 rounded-xl bg-primary px-4 text-sm font-semibold text-primary-foreground transition hover:bg-primary/90"
                onClick={onAddMoment}
                type="button"
              >
